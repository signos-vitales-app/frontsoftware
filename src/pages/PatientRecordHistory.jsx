...
const PatientRecordHistory = () => {
    ...
    const vitalSignRanges = {
        ...
        temperatura: {
            'Recién nacido': { min: 36.0, max: 37.9 },
            'Lactante temprano': { min: 36.0, max: 37.9 },
            'Lactante mayor': { min: 36.0, max: 37.9 },
            'Niño pequeño': { min: 36.0, max: 37.9 },
            'Preescolar temprano': { min: 36.0, max: 37.9 },
            'Preescolar tardío': { min: 36.0, max: 37.9 },
            'Adulto': { min: 36.0, max: 37.5 },
        },
        frecuencia_respiratoria: {
            'Recién nacido': { min: 30, max: 60 },
            'Lactante temprano': { min: 30, max: 60 },
            'Lactante mayor': { min: 25, max: 45 },
            'Niño pequeño': { min: 20, max: 30 },
            'Preescolar temprano': { min: 16, max: 24 },
            'Preescolar tardío': { min: 14, max: 24 },
            'Adulto': { min: 16, max: 24 },
        },
        presion_sistolica: {
            'Recién nacido': { min: 60, max: 95 },
            'Lactante temprano': { min: 70, max: 110 },
            'Lactante mayor': { min: 70, max: 110 },
            'Niño pequeño': { min: 72, max: 110 },
            'Preescolar temprano': { min: 76, max: 116 },
            'Preescolar tardío': { min: 86, max: 120 },
            'Adulto': { min: 100, max: 140 },
        },
        presion_diastolica: {
            'Recién nacido': { min: 40, max: 75 },
            'Lactante temprano': { min: 45, max: 70 },
            'Lactante mayor': { min: 50, max: 70 },
            'Niño pequeño': { min: 53, max: 70 },
            'Preescolar temprano': { min: 55, max: 75 },
            'Preescolar tardío': { min: 60, max: 85 },
            'Adulto': { min: 60, max: 100 },
        },
        saturacion_oxigeno: {
            'Recién nacido': { min: 85, max: 100 },
            'Lactante temprano': { min: 88, max: 100 },
            'Lactante mayor': { min: 88, max: 100 },
            'Niño pequeño': { min: 90, max: 100 },
            'Preescolar temprano': { min: 90, max: 100 },
            'Preescolar tardío': { min: 90, max: 100 },
            'Adulto': { min: 90, max: 100 },
        },
        presion_media: {
